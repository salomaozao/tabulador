...
CATEGORIZADOR_PROJETO, campo "ativo" do projetos.json, primeiro da lista.
...
def padrao() -> str:
    reg = _registro()
    return os.getenv("CATEGORIZADOR_PROJETO") or reg.get("ativo") or next(iter(reg["projetos"]))
...
def ativar(slug: str | None = None, lembrar: bool = False) -> None:
    ...
    raiz_teste = os.getenv("CATEGORIZADOR_OUTPUT")  # testes automatizados: tudo numa pasta temporária
