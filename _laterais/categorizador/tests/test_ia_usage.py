...
_TMP = tempfile.mkdtemp(prefix="categorizador_ia_")
...
VARS = (["OPENAI_API_KEY", "OPENAI_MODEL", "OPENAI_BASE_URL", "OPENAI_PROVEDOR"] + [f"CATEGORIZADOR_CHAVE_{p.upper()}" for p in config.PROVEDORES]
...
class TestProvedores(unittest.TestCase):
    ...
    def test_trocar_provedor_guarda_chaves(self):
        ...
        self.assertIn("CATEGORIZADOR_CHAVE_GEMINI=AIza-teste", txt)
