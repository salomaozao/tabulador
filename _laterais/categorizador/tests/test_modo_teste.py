...
_TMP = tempfile.mkdtemp(prefix="categorizador_modoteste_")
os.environ["CATEGORIZADOR_OUTPUT"] = _TMP
os.environ["CATEGORIZADOR_SIMULADO_ATRASO"] = "0"
...
VARS = ["OPENAI_API_KEY", "OPENAI_MODEL", "OPENAI_BASE_URL", "OPENAI_PROVEDOR", "CATEGORIZADOR_ANTES_TESTE_PROVEDOR",
        "CATEGORIZADOR_ANTES_TESTE_MODELO", "CATEGORIZADOR_ANTES_TESTE_URL"] + [f"CATEGORIZADOR_CHAVE_{p.upper()}" for p in config.PROVEDORES]
