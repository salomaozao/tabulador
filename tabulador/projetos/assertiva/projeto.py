...
Definição do projeto para o tabulador (ver projetos.py): planilha-fonte, contexto para a IA
...
# Saídas continuam em tabulador/output (onde já estão os resultados da Assertiva)
OUTPUT_DIR = Path(os.getenv("ASSERTIVA_OUTPUT", _TABULADOR / "output"))
